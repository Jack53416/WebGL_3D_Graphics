...
Sphere.setTexture = function(texture){
...
Sphere.prototype.rotate = function(angleX, angleY){
  ...
  mat4.rotate(newRotationMatrix, newRotationMatrix, angleX, [0, 1, 0]);
  mat4.rotate(newRotationMatrix, newRotationMatrix, angleY, [1, 0, 0]);
